...
`Exercise_2.1_Reconstruccion.md` y `PRD.md`).
...
| **Cobro y confirmación de pago** | Obtener y validar el pago antes de despachar. | El sistema envía un link de pago (o instrucciones de transferencia) y solicita al usuario avisar cuando haya pagado. | Confirmación del usuario "Ya pagué"; Comprobante (opcional, imagen) | Mensaje: "Estamos validando tu pago"; El caso pasa a estado "Pago pendiente de confirmación" para revisión del operador; Avanza a Pantalla 5 solo tras confirmación del operador |
